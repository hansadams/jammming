...
const Track = (props) => {
  ...
  return (
    <ul className="divide-y divide-gray-100">
      <li key={props.id} className="flex justify-between gap-x-2 p-3 my-2 bg-zinc-950 rounded-xl hover:bg-zinc-700">
        <div className="flex min-w-0 gap-x-4 ">
          ...
          <div className="min-w-0 flex-auto">
            ...
            <p className=" truncate text-xs leading-5 text-zinc-400">{props.track.artist} • {props.track.album} </p>
          </div>
        </div>
